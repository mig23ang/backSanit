...
let Refine = new SchemaObj(
    {
        ...
        netW: {type: Number},
        grossW: {type: Number},
        uniteId: { type: SchemaObj.Types.ObjectId, ref: 'unite', required : [true,"La unidad del producto es requerida"]},
...
Refine.plugin(pag);
Refine.plugin(uniqueValidator, {"message":"ya se encuentra un registro con  {PATH} registrado!"});

module.exports = mongObj.model('Refine', Refine);